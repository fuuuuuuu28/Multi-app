...
const TodoPage = () => {
  ...
  return (
    <div className="flex-col w-[80%] mt-14 mx-auto space-y-8">
      {/* Input Todo */}
      <div className="flex items-center justify-center gap-2 h-[150px] bg-zinc-100 rounded-xl shadow-lg">
        <input
          type="text"
      ...
      {/* List */}
      <div className="flex-col h-full bg-zinc-100 rounded-xl">
